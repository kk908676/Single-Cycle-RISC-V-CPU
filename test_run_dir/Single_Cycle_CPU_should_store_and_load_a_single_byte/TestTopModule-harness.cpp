...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/an/ca2023-lab3/test_run_dir/Single_Cycle_CPU_should_store_and_load_a_single_byte/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/an/ca2023-lab3/test_run_dir/Single_Cycle_CPU_should_store_and_load_a_single_byte/TestTopModule.)";
