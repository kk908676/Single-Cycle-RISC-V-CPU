...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/an/ca2023-lab3/test_run_dir/Single_Cycle_CPU_should_recursively_calculate_Fibonacci10/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/an/ca2023-lab3/test_run_dir/Single_Cycle_CPU_should_recursively_calculate_Fibonacci10/TestTopModule.)";
